...
function add_whatsapp_btn_in_list_orders($order)
{
    ...
    $text = "Estimad@ $first_name $last_name. Bigcom agradece tu compra tu compra y el interés en nuestros productos. Estamos procesando tu pedio y nos aseguraremos de que lo recibas lo más pronto posible.";
    ?>
