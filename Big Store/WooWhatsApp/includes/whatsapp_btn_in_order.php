...
function whatsapp_btn_in_order($order_id)
{
    ...
    $text = "Estimad@ $first_name $last_name. Bigcom agradece tu compra y el interés en nuestros productos. Estamos procesando tu pedio y nos aseguraremos de que lo recibas lo más pronto posible.";
    ?>
<p>
