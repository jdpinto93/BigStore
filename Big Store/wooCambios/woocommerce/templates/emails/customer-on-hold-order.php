...
<tr>
			<td class="header-text" style="vertical-align: top; box-sizing: border-box; padding: 30px 0px 30px 0px; font-size: 0; padding-top: 15px; padding-right: 0px; padding-bottom: 15px; padding-left: 0px;">
				<h1 style="margin: 0 auto; width: 100%; max-width: 100%; mso-line-height-rule: exactly; vertical-align: middle; border: 1px solid transparent; box-sizing: border-box; font-size: 40px; color: #ffffff; font-weight: 650; text-align: center; line-height: 100%; font-family: Arial, Helvetica, sans-serif;">Pedido en Espera de Pago</h1>
			</td>
		</tr>
	</table>
<table class="thwec-block thwec-block-text builder-block" id="tp_1011" cellspacing="0" cellpadding="0" style="table-layout: fixed; margin: 0 auto; box-sizing: border-box; color: #000000; font-size: 15px; line-height: 22px; font-weight: 600; font-family: Arial, Helvetica, sans-serif; width: 100%; margin-top: 0px; margin-right: auto; margin-bottom: 0px; margin-left: auto; text-align: left;">
		<tr style="color: #000000; font-size: 15px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">
			<td class="thwec-block-child thwec-block-text-holder" style="vertical-align: top; box-sizing: border-box; padding: 15px 15px; color: #000000; font-size: 15px; font-weight: 600; line-height: 22px; text-align: left; font-family: Arial, Helvetica, sans-serif; background-color: transparent; background-image: none; background-size: 100%; background-position: center; background-repeat: no-repeat; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-color: transparent; border-style: none; padding-top: 20px; padding-right: 0px; padding-bottom: 0px; padding-left: 10px;">
			<div class="wec-txt-wrap" style="color: #000000; font-size: 15px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">¡<?php if(isset($order)) : ?><?php echo $order->get_billing_first_name(); ?><?php elseif ( isset( $user_login ) ) : ?><?php $user = get_user_by('login', $user_login ); echo $user->first_name; ?><?php endif; ?>, gracias por comprar en bigcom.com.mx!<br style="color: #000000; font-size: 15px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">
</div>
<div class="wec-txt-wrap" style="color: #000000; font-size: 15px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">Este correo electrónico es para confirmar que tu pedido está pendiente de pago, una vez confirmemos que se ha completado tu pago te enviaremos otro correo electrónico con la confirmacion y el seguimiento correspondiente de tu orden.<br style="color: #000000; font-size: 15px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">
</div>
<div class="wec-txt-wrap" style="color: #000000; font-size: 15px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;"><br style="color: #000000; font-size: 15px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;"></div>
			</td>
		</tr>
	</table>
<?php if(isset($order)){ ?>
...
<table class="thwec-row thwec-block-two-column builder-block" id="tp_1023" cellpadding="0" cellspacing="0" style="border-spacing: 0px; width: 100%; table-layout: fixed; max-width: 100%; margin: 0 auto; padding-top: 12px; padding-right: 10px; padding-bottom: 12px; padding-left: 10px; margin-top: 0px; margin-right: auto; margin-bottom: 0px; margin-left: auto; border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; border-style: none; border-color: #dddddd; background-image: url('https://bigcom.com.mx/cdn/uploads/2022/05/E-mail-marketing-pedido-1-3.png'); background-color: #ffffff; background-position: center; background-size: 100%; background-repeat: no-repeat;"><tr>
<td class="column-padding thwec-col thwec-columns" id="tp_1024" style="box-sizing: border-box; word-break: break-word; padding: 10px 10px; width: 50%; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px; border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; border-style: none; border-color: #dddddd; background-image: none; background-color: transparent; background-position: center; background-size: 100%; background-repeat: no-repeat; text-align: center; vertical-align: top;"><table class="thwec-block thwec-block-text builder-block" id="tp_1026" cellspacing="0" cellpadding="0" style="table-layout: fixed; margin: 0 auto; box-sizing: border-box; color: #000000; text-align: justify; font-size: 14px; line-height: 22px; font-weight: normal; font-family: Arial, Helvetica, sans-serif; width: 100%; margin-top: 0px; margin-right: auto; margin-bottom: 0px; margin-left: auto;">
		<tr style="color: #000000; font-size: 14px; font-weight: normal; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">
			<td class="thwec-block-child thwec-block-text-holder" style="vertical-align: top; box-sizing: border-box; padding: 15px 15px; color: #000000; font-size: 14px; font-weight: normal; line-height: 22px; text-align: justify; font-family: Arial, Helvetica, sans-serif; background-color: transparent; background-image: none; background-size: 100%; background-position: center; background-repeat: no-repeat; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-color: transparent; border-style: none; padding-top: 15px; padding-right: 15px; padding-bottom: 15px; padding-left: 15px;">
			<div class="wec-txt-wrap" style="color: #000000; font-size: 14px; font-weight: normal; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">En caso de que tu medio de pago sea por transferencia bancaria podras realizar tu pago directamente en nuestra cuenta bancaria. Por favor, usa el número del pedido como referencia de pago. <br style="color: #000000; font-size: 14px; font-weight: normal; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">
</div>
<div class="wec-txt-wrap" style="color: #000000; font-size: 14px; font-weight: normal; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">Tu pedido no se procesará hasta que se haya recibido el importe en nuestra cuenta. Una vez finalizado el pago carga tu recibo de forma correcta en el panel de pedidos para completar el proceso.<br style="color: #000000; font-size: 14px; font-weight: normal; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">
</div>
			</td>
		</tr>
	</table></td>
<td class="column-padding thwec-col thwec-columns" id="tp_1025" style="box-sizing: border-box; word-break: break-word; padding: 10px 10px; width: 50%; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px; border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; border-style: none; border-color: #dddddd; background-image: none; background-color: transparent; background-position: center; background-size: 100%; background-repeat: no-repeat; text-align: center; vertical-align: top;"><table class="thwec-block thwec-block-text builder-block" id="tp_1027" cellspacing="0" cellpadding="0" style="table-layout: fixed; margin: 0 auto; box-sizing: border-box; color: #000000; text-align: left; font-size: 15px; line-height: 22px; font-weight: 600; font-family: Arial, Helvetica, sans-serif; width: 100%; margin-top: 0px; margin-right: auto; margin-bottom: 0px; margin-left: auto;">
		<tr style="color: #000000; font-size: 15px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">
			<td class="thwec-block-child thwec-block-text-holder" style="vertical-align: top; box-sizing: border-box; padding: 15px 15px; color: #000000; font-size: 15px; font-weight: 600; line-height: 22px; text-align: left; font-family: Arial, Helvetica, sans-serif; background-color: transparent; background-image: none; background-size: 100%; background-position: center; background-repeat: no-repeat; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-color: transparent; border-style: none; padding-top: 15px; padding-right: 15px; padding-bottom: 15px; padding-left: 15px;">
			<div class="wec-txt-wrap" style="color: #000000; font-size: 15px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">Empresa:<br style="color: #000000; font-size: 15px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">
</div>
<div class="wec-txt-wrap" style="color: #000000; font-size: 15px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">MDF COMPUTACION SA DE CV<br style="color: #000000; font-size: 15px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">
</div>
<div class="wec-txt-wrap" style="color: #000000; font-size: 15px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">Banco:<br style="color: #000000; font-size: 15px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">
</div>
<div class="wec-txt-wrap" style="color: #000000; font-size: 15px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">SANTANDER<br style="color: #000000; font-size: 15px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">
</div>
<div class="wec-txt-wrap" style="color: #000000; font-size: 15px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">Nro de cuenta:<br style="color: #000000; font-size: 15px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">
</div>
<div class="wec-txt-wrap" style="color: #000000; font-size: 15px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">65505580795<br style="color: #000000; font-size: 15px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">
</div>
<div class="wec-txt-wrap" style="color: #000000; font-size: 15px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">Clave Interbancaria:<br style="color: #000000; font-size: 15px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">
</div>
<div class="wec-txt-wrap" style="color: #000000; font-size: 15px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">014650655055807955<br style="color: #000000; font-size: 15px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">
</div>
<div class="wec-txt-wrap" style="color: #000000; font-size: 15px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;"><br style="color: #000000; font-size: 15px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;"></div>
<div class="wec-txt-wrap" style="color: #000000; font-size: 15px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">Para mas información<br style="color: #000000; font-size: 15px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">
</div>
<div class="wec-txt-wrap" style="color: #000000; font-size: 15px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">whatsapp: +525520801952<br style="color: #000000; font-size: 15px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">
</div>
<div class="wec-txt-wrap" style="color: #000000; font-size: 15px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;"><br style="color: #000000; font-size: 15px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;"></div>
<div class="wec-txt-wrap" style="color: #000000; font-size: 15px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;"><br style="color: #000000; font-size: 15px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;"></div>
			</td>
