...
<tr>
			<td class="header-text" style="vertical-align: top; box-sizing: border-box; padding: 30px 0px 30px 0px; font-size: 0; padding-top: 15px; padding-right: 0px; padding-bottom: 15px; padding-left: 0px;">
				<h1 style="margin: 0 auto; width: 100%; max-width: 100%; mso-line-height-rule: exactly; vertical-align: middle; border: 1px solid transparent; box-sizing: border-box; font-size: 35px; color: #ffffff; font-weight: 650; text-align: center; line-height: 100%; font-family: Arial, Helvetica, sans-serif;">¡Felicidades! Bigcom ha recibido un nuevo pedido.</h1>
			</td>
		</tr>
	</table>
<table class="thwec-block thwec-block-text builder-block" id="tp_1021" cellspacing="0" cellpadding="0" style="table-layout: fixed; margin: 0 auto; box-sizing: border-box; color: #000000; text-align: center; font-size: 20px; line-height: 22px; font-weight: 650; font-family: Arial, Helvetica, sans-serif; width: 100%; margin-top: 0px; margin-right: auto; margin-bottom: 0px; margin-left: auto;">
		<tr style="color: #000000; font-size: 20px; font-weight: 650; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">
			<td class="thwec-block-child thwec-block-text-holder" style="vertical-align: top; box-sizing: border-box; padding: 15px 15px; color: #000000; font-size: 20px; font-weight: 650; line-height: 22px; text-align: center; font-family: Arial, Helvetica, sans-serif; background-color: transparent; background-image: none; background-size: 100%; background-position: center; background-repeat: no-repeat; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-color: transparent; border-style: none; padding-top: 15px; padding-right: 15px; padding-bottom: 15px; padding-left: 15px;">
			<div class="wec-txt-wrap" style="color: #000000; font-size: 20px; font-weight: 650; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">Has recibido un nuevo pedido de <?php if(isset($order)) : ?><?php echo $order->get_billing_first_name().' '.$order->get_billing_last_name(); ?><?php elseif ( isset( $user_login ) ) : ?><?php $user = get_user_by('login', $user_login ); echo $user->first_name.' '.$user->last_name; ?><?php endif; ?>.<br style="color: #000000; font-size: 20px; font-weight: 650; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">
</div>
			</td>
		</tr>
	</table>
<?php if(isset($order)){ ?>
		<table class="thwec-block thwec-block-order builder-block" id="tp_1022" cellpadding="0" cellspacing="0" align="center" style="table-layout: fixed; margin: 0 auto; position: relative; background-position: center; text-align: center; width: 100%; background-color: transparent; margin-top: 0px; margin-right: auto; margin-bottom: 0px; margin-left: auto; background-image: none; background-size: 100%; background-repeat: no-repeat; border-top-width: 2px; border-right-width: 2px; border-bottom-width: 2px; border-left-width: 2px; border-style: none; border-color: transparent;">
			<tr class="before_order_table"></tr>
			<tr>
				<td class="order-padding" align="center" style="vertical-align: top; box-sizing: border-box; word-break: unset; padding: 20px 48px; padding-top: 5px; padding-right: 5px; padding-bottom: 5px; padding-left: 5px;">
					<?php $text_align = is_rtl() ? "right" : "left"; ?>
  					<h2 class="thwec-order-heading" style="color: #000000; font-size: 28px; text-align: center; font-weight: 700; line-height: 100%; font-family: Arial, Helvetica, sans-serif;"><?php
		if ( $sent_to_admin ) {
	...
	if ( apply_filters( "woocommerce_order_item_visible", true, $item ) ) {
		...
		if(isset($order)){
			...
			if ( isset($order) && $order->get_customer_note() ) {
				?>
				<tr>
					<th class="td" scope="row" colspan="2" style="color:#000000;text-align:left;font-size:16px;line-height:100%;font-weight:;padding-top:10px;padding-right:0px;padding-bottom:10px;padding-left:5px;border-color:#ff0000;font-family:Arial, Helvetica, sans-serif;"><?php esc_html_e( 'Note:', 'woocommerce' ); ?></th>
					<td class="td" style="color:#000000;text-align:left;font-size:16px;line-height:100%;font-weight:;padding-top:10px;padding-right:0px;padding-bottom:10px;padding-left:5px;border-color:#ff0000;font-family:Arial, Helvetica, sans-serif;"><?php echo wp_kses_post( wptexturize( $order->get_customer_note() ) ); ?></td>
				</tr>
				<?php
			}
		}
		...
		<?php } ?><table class="thwec-block thwec-block-text builder-block" id="tp_1069" cellspacing="0" cellpadding="0" style="table-layout: fixed; margin: 0 auto; box-sizing: border-box; color: #000000; text-align: center; font-size: 22px; line-height: 22px; font-weight: 650; font-family: Arial, Helvetica, sans-serif; width: 100%; margin-top: 0px; margin-right: auto; margin-bottom: 0px; margin-left: auto;">
		<tr style="color: #000000; font-size: 22px; font-weight: 650; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">
			...
			<div class="wec-txt-wrap" style="color: #000000; font-size: 22px; font-weight: 650; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">Puedes revisar el estatus y el detalle del pedido en la sección de Pedidos.<br style="color: #000000; font-size: 22px; font-weight: 650; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">
</div>
			</td>
		</tr>
	</table>
<table class="thwec-block thwec-button-wrapper-table builder-block" id="tp_1028" cellspacing="0" cellpadding="0" style="table-layout: fixed; margin: 0 auto; width: 280px; height: 20px; margin-top: 0px; margin-right: auto; margin-bottom: 0px; margin-left: auto; padding-top: 10px; padding-right: 0px; padding-bottom: 10px; padding-left: 0px;">
		<tr>
			<td class="thwec-block-child thwec-button-wrapper" style="vertical-align: top; box-sizing: border-box; border-radius: 2px; padding: 10px 0px; text-decoration: none; font-size: 22px; font-family: Tahoma, Geneva, sans-serif; color: #ffffff; background-color: #ff0000; background-image: none; background-repeat: no-repeat; background-size: 100%; background-position: center; border-top-width: 1px; border-bottom-width: 1px; border-left-width: 1px; border-right-width: 1px; border-style: solid; border-color: #ff0000; padding-top: 10px; padding-right: 0px; padding-bottom: 10px; padding-left: 0px; text-align: center;">
      			<a href="https://bigcom.com.mx/wp-admin/edit.php?post_type=shop_order" title="IR AL PANEL DE PEDIDOS" class="thwec-button-link" style="text-decoration: none; line-height: 150%; font-size: 22px; font-family: Tahoma, Geneva, sans-serif; color: #ffffff; text-align: center;">IR AL PANEL DE PEDIDOS</a>
  			</td>
		</tr>
	</table>
</td></tr></table>
<table class="thwec-row thwec-block-two-column builder-block" id="tp_1054" cellpadding="0" cellspacing="0" style="border-spacing: 0px; width: 100%; table-layout: fixed; max-width: 100%; margin: 0 auto; padding-top: 12px; padding-right: 10px; padding-bottom: 12px; padding-left: 10px; margin-top: 0px; margin-right: auto; margin-bottom: 0px; margin-left: auto; border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; border-style: none; border-color: #dddddd; background-image: url('https://bigcom.com.mx/cdn/uploads/2022/05/E-mail-marketing-pedido-1-3.png'); background-color: transparent; background-position: center; background-size: 100%; background-repeat: no-repeat;"><tr>
<td class="column-padding thwec-col thwec-columns" id="tp_1055" style="box-sizing: border-box; word-break: break-word; padding: 10px 10px; width: 50%; padding-top: 10px; padding-right: 20px; padding-bottom: 0px; padding-left: 20px; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-style: none; border-color: transparent; background-image: none; background-color: #d3d3d3; background-position: center; background-size: 100%; background-repeat: no-repeat; text-align: center; vertical-align: top;">
<?php if(isset($order)){?>
        <table class="thwec-block thwec-block-billing builder-block" id="tp_1026" cellspacing="0" cellpadding="0" align="center" style="width: 100%; table-layout: fixed; margin: 0; padding: 0; border: 0px none transparent; border-collapse: collapse; box-sizing: border-box;">
			<tr>
					...
					<table class="thwec-address-wrapper-table" cellpadding="0" cellspacing="0" style="width: 100%; height: 115px; background-color: transparent; background-image: none; background-size: 100%; background-position: center; background-repeat: no-repeat; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-style: none; border-color: transparent; margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px;">
						<tr>
							<td class="billing-padding" style="vertical-align: top; box-sizing: border-box; padding: 5px 0px 2px 0px; padding-top: 5px; padding-right: 0px; padding-bottom: 2px; padding-left: 0px;">
								<h2 class="thwec-billing-header" style="display: block; margin: 0px; font-size: 18px; color: #ff0000; text-align: left; font-weight: bold; line-height: 100%; font-family: Arial, Helvetica, sans-serif;">Detalles de Facturacion</h2>
		      					<p class="address thwec-billing-body" style="margin: 13px 0px; padding: 0px 0px 0px 0px; font-size: 14px; color: #000000; text-align: left; font-family: Arial, Helvetica, sans-serif; font-weight: normal; line-height: 150%; border: 0px;">
...
<td class="column-padding thwec-col thwec-columns" id="tp_1056" style="box-sizing: border-box; word-break: break-word; padding: 10px 10px; width: 50%; padding-top: 10px; padding-right: 20px; padding-bottom: 0px; padding-left: 20px; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-style: none; border-color: transparent; background-image: none; background-color: #d3d3d3; background-position: center; background-size: 100%; background-repeat: no-repeat; text-align: center; vertical-align: top;">
<?php if(isset($order)){?>
	<?php if ( ! wc_ship_to_billing_address_only() && $order->needs_shipping_address() && ( $shipping = $order->get_formatted_shipping_address() ) ) : ?>
	<table class="thwec-block thwec-block-shipping builder-block" id="tp_1027" cellspacing="0" cellpadding="0" align="center" style="width: 100%; table-layout: fixed; margin: 0; padding: 0; border: 0px none transparent; border-collapse: collapse; box-sizing: border-box;">
		<tr>
			<td class="thwec-block-child thwec-address-alignment" align="center" style="vertical-align: top; margin: 0; padding: 0; border: 0px none transparent; border-collapse: collapse; box-sizing: border-box;">
				<table class="thwec-address-wrapper-table" cellpadding="0" cellspacing="0" style="width: 100%; height: 115px; background-color: transparent; background-image: none; background-size: 100%; background-position: center; background-repeat: no-repeat; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-style: none; border-color: transparent; margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px;">
					<tr>
						<td class="shipping-padding" style="vertical-align: top; box-sizing: border-box; padding: 5px 0px 2px 0px; padding-top: 5px; padding-right: 0px; padding-bottom: 2px; padding-left: 0px;">
 							<h2 class="thwec-shipping-header" style="display: block; margin: 0px; font-size: 18px; color: #ff0000; text-align: left; font-weight: bold; line-height: 100%; font-family: Arial, Helvetica, sans-serif;">Detalles de Envio</h2>
							<p class="address thwec-shipping-body" style="margin: 13px 0px; padding: 0px 0px 0px 0px; font-size: 14px; color: #000000; text-align: left; font-family: Arial, Helvetica, sans-serif; font-weight: normal; line-height: 150%; border: 0px;">
...
<table class="thwec-row thwec-block-one-column builder-block" id="tp_1038" cellpadding="0" cellspacing="0" style="width: 100%; table-layout: fixed; max-width: 100%; margin: 0 auto; border-spacing: 0px; padding-top: 12px; padding-right: 10px; padding-bottom: 12px; padding-left: 10px; margin-top: 0px; margin-right: auto; margin-bottom: 0px; margin-left: auto; border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; border-style: none; border-color: #ffffff; background-image: none; background-color: #444444; background-position: center; background-size: 100%; background-repeat: no-repeat;"><tr><td class="column-padding thwec-col thwec-columns" id="tp_1039" style="box-sizing: border-box; word-break: break-word; padding: 10px 10px; width: 100%; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px; text-align: center; border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; border-style: none; border-color: #dddddd; background-image: none; background-color: transparent; background-position: center; background-size: 100%; background-repeat: no-repeat; vertical-align: middle;">
<table class="thwec-block thwec-block-image builder-block" id="tp_1066" cellspacing="0" cellpadding="0" align="center" style="table-layout: fixed; width: 100%; height: auto; max-width: 600px; box-sizing: border-box; margin-top: 0px; margin-right: auto; margin-bottom: 0px; margin-left: auto; background-color: transparent;">
		<tr>
...
<table class="thwec-block thwec-block-text builder-block" id="tp_1040" cellspacing="0" cellpadding="0" style="table-layout: fixed; margin: 0 auto; box-sizing: border-box; color: #ffffff; text-align: center; font-size: 15px; line-height: 22px; font-weight: 700; font-family: Arial, Helvetica, sans-serif; width: 100%; margin-top: 0px; margin-right: auto; margin-bottom: 0px; margin-left: auto;">
		<tr style="color: #ffffff; font-size: 15px; font-weight: 700; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">
			<td class="thwec-block-child thwec-block-text-holder" style="vertical-align: top; box-sizing: border-box; padding: 15px 15px; color: #ffffff; font-size: 15px; font-weight: 700; line-height: 22px; text-align: center; font-family: Arial, Helvetica, sans-serif; background-color: transparent; background-image: none; background-size: 100%; background-position: center; background-repeat: no-repeat; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-color: transparent; border-style: none; padding-top: 15px; padding-right: 15px; padding-bottom: 15px; padding-left: 15px;">
			<div class="wec-txt-wrap" style="color: #ffffff; font-size: 15px; font-weight: 700; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">Bigcom © 2022. Derechos Reservados.<br style="color: #ffffff; font-size: 15px; font-weight: 700; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">
</div>
<div class="wec-txt-wrap" style="color: #ffffff; font-size: 15px; font-weight: 700; line-height: 22px; font-family: Arial, Helvetica, sans-serif;"><br style="color: #ffffff; font-size: 15px; font-weight: 700; line-height: 22px; font-family: Arial, Helvetica, sans-serif;"></div>
<div class="wec-txt-wrap" style="color: #ffffff; font-size: 15px; font-weight: 700; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">Av. Pinos, Sta Cruz Buenavista, 72170 Puebla, Pue.<br style="color: #ffffff; font-size: 15px; font-weight: 700; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">
</div>
			</td>
		</tr>
	</table>
<table class="thwec-block thwec-block-social builder-block" id="tp_1068" cellspacing="0" cellpadding="0" style="table-layout: fixed; width: 100%; box-sizing: border-box; margin: 0 auto; text-align: center; margin-top: 0px; margin-right: auto; margin-bottom: 0px; margin-left: auto; background-color: transparent; background-image: none; background-size: 100%; background-position: center; background-repeat: no-repeat; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-style: none; border-color: transparent;">
		<tr>
