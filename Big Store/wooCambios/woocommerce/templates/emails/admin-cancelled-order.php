...
<tr>
			<td class="header-text" style="vertical-align: top; box-sizing: border-box; padding: 30px 0px 30px 0px; font-size: 0; padding-top: 15px; padding-right: 0px; padding-bottom: 15px; padding-left: 0px;">
				<h1 style="margin: 0 auto; width: 100%; max-width: 100%; mso-line-height-rule: exactly; vertical-align: middle; border: 1px solid transparent; box-sizing: border-box; font-size: 40px; color: #ffffff; font-weight: 650; text-align: center; line-height: 100%; font-family: Arial, Helvetica, sans-serif;">¡Orden cancelada!</h1>
			</td>
		</tr>
	</table>
<table class="thwec-block thwec-block-text builder-block" id="tp_1011" cellspacing="0" cellpadding="0" style="table-layout: fixed; margin: 0 auto; box-sizing: border-box; color: #000000; font-size: 20px; line-height: 22px; font-weight: 600; font-family: Arial, Helvetica, sans-serif; width: 100%; margin-top: 0px; margin-right: auto; margin-bottom: 0px; margin-left: auto; text-align: left;">
		<tr style="color: #000000; font-size: 20px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">
			<td class="thwec-block-child thwec-block-text-holder" style="vertical-align: top; box-sizing: border-box; padding: 15px 15px; color: #000000; font-size: 20px; font-weight: 600; line-height: 22px; text-align: left; font-family: Arial, Helvetica, sans-serif; background-color: transparent; background-image: none; background-size: 100%; background-position: center; background-repeat: no-repeat; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-color: transparent; border-style: none; padding-top: 20px; padding-right: 0px; padding-bottom: 0px; padding-left: 10px;">
			<div class="wec-txt-wrap" style="color: #000000; font-size: 20px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">Hola <?php if(isset($order)) : ?><?php echo $order->get_billing_first_name().' '.$order->get_billing_last_name(); ?><?php elseif ( isset( $user_login ) ) : ?><?php $user = get_user_by('login', $user_login ); echo $user->first_name.' '.$user->last_name; ?><?php endif; ?> este correo es para notificarte que tu orden #<?php if(isset($order)) : ?><?php echo $order->get_id();?><?php endif; ?> ha sido cancelada, si crees que esto es un error por favor contactanos para hacer seguimiento de tu pedido.<br style="color: #000000; font-size: 20px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">
</div>
<div class="wec-txt-wrap" style="color: #000000; font-size: 20px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;"><br style="color: #000000; font-size: 20px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;"></div>
<div class="wec-txt-wrap" style="color: #000000; font-size: 20px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">¡Es nuestro desafío ser tu mejor opción!<br style="color: #000000; font-size: 20px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">
</div>
<div class="wec-txt-wrap" style="color: #000000; font-size: 20px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;"><br style="color: #000000; font-size: 20px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;"></div>
			</td>
		</tr>
...
<?php if(isset($order)){ ?>
	...
	if ( apply_filters( "woocommerce_order_item_visible", true, $item ) ) {
		...
		<tr style="color: #000000; font-size: 20px; font-weight: 700; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">
			<td class="thwec-block-child thwec-block-text-holder" style="vertical-align: top; box-sizing: border-box; padding: 15px 15px; color: #000000; font-size: 20px; font-weight: 700; line-height: 22px; text-align: center; font-family: Arial, Helvetica, sans-serif; background-color: transparent; background-image: none; background-size: 100%; background-position: center; background-repeat: no-repeat; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-color: transparent; border-style: none; padding-top: 10px; padding-right: 5px; padding-bottom: 0px; padding-left: 5px;">
			<div class="wec-txt-wrap" style="color: #000000; font-size: 20px; font-weight: 700; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">Podras ver los detalles de tu orden en tu cuenta.<br style="color: #000000; font-size: 20px; font-weight: 700; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">
</div>
			</td>
		</tr>
	</table>
