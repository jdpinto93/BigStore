...
<table class="thwec-block thwec-block-text builder-block" id="tp_1011" cellspacing="0" cellpadding="0" style="table-layout: fixed; margin: 0 auto; box-sizing: border-box; color: #000000; font-size: 18px; line-height: 22px; font-weight: 600; font-family: Arial, Helvetica, sans-serif; width: 100%; margin-top: 0px; margin-right: auto; margin-bottom: 0px; margin-left: auto; text-align: left;">
		<tr style="color: #000000; font-size: 18px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">
			...
			<div class="wec-txt-wrap" style="color: #000000; font-size: 18px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">¡<?php if(isset($order)) : ?><?php echo $order->get_billing_first_name().' '.$order->get_billing_last_name(); ?><?php elseif ( isset( $user_login ) ) : ?><?php $user = get_user_by('login', $user_login ); echo $user->first_name.' '.$user->last_name; ?><?php endif; ?>, gracias por comprar en bigcom.com.mx!<br style="color: #000000; font-size: 18px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">
</div>
<div class="wec-txt-wrap" style="color: #000000; font-size: 18px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">Este correo electrónico es para confirmar que se envio con exito tu pedido. <br style="color: #000000; font-size: 18px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">
</div>
<div class="wec-txt-wrap" style="color: #000000; font-size: 18px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">Te dejamos la informacion de envio en el panel de tu cuenta.<br style="color: #000000; font-size: 18px; font-weight: 600; line-height: 22px; font-family: Arial, Helvetica, sans-serif;">
</div>
			</td>
		</tr>
	</table>
