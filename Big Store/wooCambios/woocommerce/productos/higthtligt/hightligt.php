...
function gallery_metabox_enqueue($hook) {
  if ( 'post.php' == $hook || 'post-new.php' == $hook ) {
    wp_enqueue_script( 'woo-add-higtthligt', Woo_Big_URL . 'wooCambios/woocommerce/productos/higthtligt/js/gallery-metabox.js', array('jquery', 'jquery-ui-sortable' ), true );
    wp_enqueue_style( 'woo-add-higtthligt', Woo_Big_URL . 'wooCambios/woocommerce/productos/higthtligt/css/gallery-metabox.css');
  }
}
