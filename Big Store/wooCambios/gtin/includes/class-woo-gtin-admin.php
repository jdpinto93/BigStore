    ...
    class Woo_GTIN_Admin {
        ...
        public function gtin_settings( $settings, $current_section ) {
            ...
            if ( $current_section == 'inventory' ) {
                ...
                $settings[] = array( 'name' => __( 'Configurar GTIN', 'woo-add-gtin' ), 'type' => 'title', 'desc' => __( 'Las siguientes opciones se utilizan cambiar los valores de GTIN', 'woo-add-gtin' ), 'id' => 'woo-add-gtin' );
                // Add first checkbox option
                $settings[] = array(
                    'name'     => __( '¿Ocultar GTIN en páginas de un solo producto?', 'woo-add-gtin' ),
                ...
                $settings[] = array(
                    'name'     => __( 'Cambiar Nombre GTIN', 'woo-add-gtin' ),
