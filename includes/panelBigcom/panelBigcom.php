...
<div>
  ...
  <div class="infotarjeta">
    ...
    <a href="admin.php?page=th_checkout_field_editor_pro" class="botonTarjetas">Configurar Checkout</a>
  </div>
    </div>
  ...
  <div class="infotarjeta">
    ...
    <a href="admin.php?page=wc-settings&tab=alg_wc_checkout_files_upload" class="botonTarjetas">Configurar Boton</a>
  </div>
    </div>
  ...
  <div class="infotarjeta">
    ...
    <a href="admin.php?page=wc-settings&tab=checkout" class="botonTarjetas">Agregar Metodo</a>
  </div>
    </div>
  </div>
</div>
