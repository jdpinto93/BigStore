	...
	public function init_form_fields() {
		...
		$form_fields = array(
			...
			'enabled' => array(
				...
				'type'        => 'checkbox',
				'label'       => __( 'Activar este aviso por correo electrónico', 'woocommerce-order-status-manager' ),
				'default'     => 'no',
			),

			'recipient' => array(
				'title'       => __( 'Destinatarios(s)', 'woocommerce-order-status-manager' ),
				'type'        => 'text',
				/* translators: %s - admin email as default option */
				'description' => sprintf( __( 'Introduzca los destinatarios (separados por comas) para este correo electrónico. Predeterminado a <code>%s</code>.', 'woocommerce-order-status-manager' ), esc_attr( get_option( 'admin_email' ) ) ),
				'placeholder' => '',
				'default'     => '',
			),

			'subject' => array(
				'title'       => __( 'Asunto', 'woocommerce-order-status-manager' ),
				'type'        => 'text',
				/* translators: %s - the default subject text */
				'description' => sprintf( __( 'Esto controla la línea de asunto del correo electrónico. Déjelo en blanco para usar el asunto predeterminado: <code>%s</code>.', 'woocommerce-order-status-manager' ), $this->subject ),
				'placeholder' => '',
				'default'     => '',
			),

			'heading' => array(
				'title'       => __( 'Encabezado del correo electrónico', 'woocommerce-order-status-manager' ),
				'type'        => 'text',
				/* translators: %s - the default heading text */
				'description' => sprintf( __( 'Esto controla el encabezado principal contenido en la notificación por correo electrónico. Déjelo en blanco para usar el encabezado predeterminado: <code>%s</code>.', 'woocommerce-order-status-manager' ), $this->heading ),
				'placeholder' => '',
				'default'     => '',
			),

			'body_text' => array(
				'title'       => __( 'Contenido adicional', 'woocommerce-order-status-manager' ),
				'type'        => 'textarea',
				'description' => __( 'Texto del cuerpo del correo electrónico opcional. Puede utilizar los siguientes marcadores de posición: <code>{order_date}, {order_number}, {order_status}, {billing_first_name}, {billing_last_name}, {billing_company}, {blogname}, {site_title}</code>', 'woocommerce-order-status-manager' ),
				'placeholder' => '',
				'default'     => $this->default_body_text,
			),

			'email_type' => array(
				'title'       => __( 'Tipo de correo electrónico', 'woocommerce-order-status-manager' ),
				'type'        => 'select',
				'description' => __( 'Elija qué formato de correo electrónico enviar.', 'woocommerce-order-status-manager' ),
				'default'     => 'html',
				'class'       => 'email_type',
				'options'     => array(
