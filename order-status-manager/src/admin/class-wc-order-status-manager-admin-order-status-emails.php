...
class WC_Order_Status_Manager_Admin_Order_Status_Emails {
	...
	public function order_status_email_actions( $actions, WP_Post $post ) {
		...
		$actions['customize_email'] = sprintf(
			...
			esc_attr__( 'Editar Email', 'woocommerce-order-status-manager' ),
			esc_url( admin_url( 'admin.php?page=wc-settings&tab=email&section=wc_order_status_email_' . esc_attr( $post->ID ) ) ),
			__( 'Editar Email', 'woocommerce-order-status-manager' )
		);
	...
	public function order_status_email_actions_meta_box() {
		...
		<ul class="order_status_email_actions submitbox">
			...
			<?php if ( 'post-new.php' !== $pagenow ) : ?>
				<li class="wide"><a href="<?php echo esc_url( admin_url( 'admin.php?page=wc-settings&tab=email&section=wc_order_status_email_' . esc_attr( $post->ID ) ) ); ?>"><?php esc_html_e( 'Editar Email', 'woocommerce-order-status-manager' ); ?></a></li>
			<?php endif; ?>

			<li class="wide">
				<div id="delete-action">
					<?php if ( current_user_can( "delete_post", $post->ID ) ) : ?>
						<a class="submitdelete deletion" href="<?php echo get_delete_post_link( $post->ID, '', true ); ?>"><?php esc_html_e( 'Eliminar', 'woocommerce-order-status-manager' ); ?></a>
					<?php endif; ?>
				</div>
