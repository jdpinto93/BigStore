...
class WCMCA_Html
{
	...
	public function render_admin_user_addresses_edit_page($user_id = null)
	{
		...
		?>
			...
			<?php if(isset($user_id)) : 
				...
				<label><?php  esc_html_e('First Name', 'woocommerce-multiple-customer-addresses'); ?></label><br /><?php if(isset($customer_extra_data['first_name'])) echo $customer_extra_data['first_name'][0]; ?> <br /><br />
				<label><?php  esc_html_e('Last Name', 'woocommerce-multiple-customer-addresses'); ?></label><br /><?php if(isset($customer_extra_data['last_name'])) echo $customer_extra_data['last_name'][0];?> <br/><br />
				<label><?php  esc_html_e('Email Address', 'woocommerce-multiple-customer-addresses'); ?></label><br /><?php echo $customer_data->user_email; ?> <br/><br />
				
				<label><?php  esc_html_e('Billing First Name', 'woocommerce-multiple-customer-addresses'); ?></label><br /><?php if(isset($customer_extra_data['billing_first_name'])) echo $customer_extra_data['billing_first_name'][0]; ?> <br /><br />
				<label><?php  esc_html_e('Billing Last Name', 'woocommerce-multiple-customer-addresses'); ?></label><br /><?php if(isset($customer_extra_data['billing_last_name'])) echo $customer_extra_data['billing_last_name'][0];?> <br/><br />
				<label><?php  esc_html_e('Biling Email Address', 'woocommerce-multiple-customer-addresses'); ?></label><br /><?php if(isset($customer_extra_data['billing_email'])) echo $customer_extra_data['billing_email'][0]; ?> <br/><br />
				
				<label><?php  esc_html_e('Registration Date', 'woocommerce-multiple-customer-addresses'); ?> </label><br /><?php echo $customer_data->user_registered; ?> <br/><br />
				<label><?php  esc_html_e('Roles', 'woocommerce-multiple-customer-addresses'); ?> </label><br /> 
							<?php 
				...
				<label><?php esc_html_e('More details', 'woocommerce-multiple-customer-addresses'); ?></label><br/>		
	...
	function addresses_list_common_scripts($is_checkout = 'no')
	{
		...
		$additional_js_options = array(
			...
			'confirm_delete_message' => esc_attr__('Address will be deleted, Are you sure?','woocommerce-multiple-customer-addresses'),
